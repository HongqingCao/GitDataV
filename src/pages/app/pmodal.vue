		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body pm-body">
		       ...
		       <p>C、本网站由于依赖github官方提供接口，对查询的次数有限制，请勿恶意攻击和压力查询,如果网站有问题请及时与开发者：<a href="https://github.com/HongqingCao" target="_blank">codercao</a>联系 </p>
		       <P>D、本网站属于非盈利性质，请勿进行商业用途，源码已开源</P>
		       <p>E、其他条款遵循<a href="https://help.github.com/articles/github-terms-of-service/" target="_blank">GitHub服务条款</a></p>
		      </div>
		      <div class="modal-footer">
		        <button type="button" class="btn btn-default"  @click="closebtn">知道了</button>
		      </div>
		    </div>
		  </div>
		</div>
